...
export enum EvidenceEpistemicClass {
  OBSERVED = 'OBSERVED',
  COMPUTED = 'COMPUTED',
...
export enum InfrastructureImpactStatus {
...
export enum SystemicIncidentStatus {
  DETECTED = 'DETECTED',
...
export enum InfrastructureProvenance {
  GIS_IMPORT = 'GIS_IMPORT',
  UTILITY_MAP = 'UTILITY_MAP',
  MUNICIPAL_SCHEMATIC = 'MUNICIPAL_SCHEMATIC',
  FIELD_VERIFIED = 'FIELD_VERIFIED',
  INFERRED = 'INFERRED',
  CONTROLLED_DEMO = 'CONTROLLED_DEMO',
}

export enum InfrastructureEdgeType {
...
export enum SentinelProbeStatus {
  DRAFT = 'DRAFT',
...
export enum SentinelChoice {
  NORMAL_SERVICE = 'NORMAL_SERVICE',
  DEGRADED_PRESSURE = 'DEGRADED_PRESSURE',
  CONTAMINATION_ODOR = 'CONTAMINATION_ODOR',
  NO_SERVICE = 'NO_SERVICE',
  UNSURE = 'UNSURE',
  OTHER = 'OTHER',
}

export enum BranchDifferentialStatus {
  CONFIRMED_AFFECTED = 'CONFIRMED_AFFECTED',
  BRANCH_UNAFFECTED_DISPROVED_UPSTREAM = 'BRANCH_UNAFFECTED_DISPROVED_UPSTREAM',
  INCONCLUSIVE = 'INCONCLUSIVE',
  INSUFFICIENT_EVIDENCE = 'INSUFFICIENT_EVIDENCE',
}
