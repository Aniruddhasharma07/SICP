...
export default function NewChallengePage() {
  ...
  if (submittedChallengeId) {
    return (
      <AppLayout>
        <div className="max-w-2xl mx-auto py-12 px-4 space-y-8 animate-in fade-in">
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 text-center space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-slate-500 max-w-md mx-auto">
                Your report has been securely registered in the SICP registry. The problem has entered the official review pipeline.
              </p>
            </div>
            ...
            <div className="bg-slate-50 rounded-xl p-5 border border-slate-200 text-left space-y-4">
              <div className="flex items-center justify-between text-xs text-slate-500">
                <span>Workflow Trajectory</span>
                <span className="font-mono text-slate-700">ID: {submittedChallengeId}</span>
              </div>

              <div className="grid grid-cols-3 gap-2 text-center text-xs">
                <div className="p-2.5 rounded-lg bg-emerald-500 text-white font-medium flex flex-col items-center gap-1 shadow-xs">
                  <Check className="w-4 h-4" />
                  <span>1. Submitted</span>
                  <span className="text-[10px] text-emerald-100">Intake Complete</span>
                </div>
                <div className="p-2.5 rounded-lg bg-blue-500 text-white font-medium flex flex-col items-center gap-1 shadow-xs animate-pulse">
                  <Sparkles className="w-4 h-4" />
                  <span>2. AI Analysis</span>
                  <span className="text-[10px] text-blue-100">In Progress</span>
                </div>
                <div className="p-2.5 rounded-lg bg-slate-200 text-slate-600 font-medium flex flex-col items-center gap-1">
                  <ShieldCheck className="w-4 h-4" />
                  <span>3. Gov Review</span>
                  <span className="text-[10px] text-slate-500">Official Decision</span>
                </div>
              </div>

              <p className="text-xs text-slate-600 leading-relaxed">
                Municipal authorities and academic researchers will be notified to review the challenge, verify local impact, and formulate research-backed solutions.
              </p>
            </div>

            {/* Zero Dead End Action Buttons */}
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <Link href={`/challenges/${submittedChallengeId}`} className="flex-1">
